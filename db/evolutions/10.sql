    ...
    alter table AS_CLIENT_TRANSACTIONS 
        drop 
        foreign key FK_9h7hadqg5p9u5bx9t2wdgpipf;

    alter table AS_CLIENT_TRANSACTIONS 
        drop 
        foreign key FK_p5hrmg2y3pllmpetk1cp8gv5x;
    ...
    alter table AS_CLIENT_TRANSACTIONS 
        add index FK_9h7hadqg5p9u5bx9t2wdgpipf (transaction), 
        add constraint FK_9h7hadqg5p9u5bx9t2wdgpipf 
        foreign key (transaction) 
        references T_TRANSACTIONS (ID);

    alter table AS_CLIENT_TRANSACTIONS 
        add index FK_p5hrmg2y3pllmpetk1cp8gv5x (client), 
        add constraint FK_p5hrmg2y3pllmpetk1cp8gv5x 
        foreign key (client) 
