...
public class BandeTable extends ModelTable {
	...
	public BandeTable() {
		this(BandeController.getInstance()
				.select("b from Bande b order by b.arrived_date desc")
				.getResultList());
	}

	public BandeTable(List models) {
		super(models);
		this.columnNames = new String[] { "TITRE", "DATE ARRIVÉE", "PRICE",
				"NOMBRE INITIAL", "COÛT", "NOMBRE RESTANT", "USER", "VENDUS" };
	}
	...
	@Override
	public void update() {
		this.models = BandeController.getInstance()
				.select("b from Bande b order by b.arrived_date desc")
				.getResultList();
	}
